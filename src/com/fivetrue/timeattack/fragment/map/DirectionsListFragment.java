...
import com.fivetrue.timeattack.view.adapter.DirectionsResultAdapter;

public class DirectionsListFragment extends BaseListFragment<RouteVO> {
	
	public interface DirectionsItemClickListener{
		public void onClickDetailItem(RouteVO item);
	}

	private DirectionsEntry mEntry = null;
	private DirectionsItemClickListener mDirectionsItemDetailClickListener = null;
	...
	private void loadData(){
		if(mEntry != null){
			setListData(mEntry.getRouteArray());
		}
	}
	
	private void setListData(ArrayList<RouteVO> arr){
		if(getActivity() == null)
			return;
		...
		if(adapter != null){
			...
			adapter = new DirectionsResultAdapter(getActivity(), arr, getColorList(), mDirectionsItemDetailClickListener);
	...
	public ArrayList<RouteVO> getDirectionsList(){
		if(adapter != null){
	...
	public DirectionsItemClickListener getDirecitonsItemClickListener() {
		return mDirectionsItemDetailClickListener;
	}

	public void setDirecitonsItemClickListener(
			DirectionsItemClickListener ll) {
		this.mDirectionsItemDetailClickListener = ll;
		if(adapter != null){
			((DirectionsResultAdapter)adapter).setDirectionsItemDetailClickListener(mDirectionsItemDetailClickListener);
		}
	}
}
